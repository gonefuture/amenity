...
public class AdminRealm extends AuthorizingRealm {
        ...
        protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
            ...
            Teacher teacher =shiroService.findByAdminId(adminId);
            if (teacher == null) {
                // 用户名不存在抛出异常
                throw new UnknownAccountException();
            }

            SimpleAuthenticationInfo authenticationInfo = new SimpleAuthenticationInfo(teacher.getYbEmployid(),
                    teacher.getScope(),getName());
